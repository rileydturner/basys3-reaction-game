...
HD_PWD='C:/Users/riley/Lab7/Lab7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_reflex.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_reflex.tcl
