...
HD_PWD='C:/Users/riley/Lab7/Lab7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log game_reflex.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source game_reflex.tcl -notrace
